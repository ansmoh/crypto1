...
<section>
	...
	<div class="mainpanel">
		...
		<div class="pageheader">
			<h2><i class="fa fa-home"></i> Dashboard <span>Add New Page</span></h2>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="profile-header">
								<form name="page_form" id="page_form" action="<?php echo base_url(); ?>admin/newPage/addpage" method="post">
									<div class="form-group">
										<label class="control-label">Title</label>
										<input type="text" class="form-control" placeholder="Enter Page Title" id="title" name="title">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<textarea name="content" id="wysiwyg" placeholder="Enter text here.." class="form-control" rows="10"></textarea>
									</div>							
...
jQuery(document).ready(function(){
	...
	jQuery("select#pagename").change(function(){
		...
		var pageid = jQuery("#pageid").val(name);
	})
});

jQuery(function() {
    jQuery("#page_form").validate({    
        rules: {
            title: "required",		
            pagename:"required",
			wysiwyg: "required",
        ...
        messages: {
            ...
            pagename: "Name is required",
            wysiwyg: "Content is required",
        },
